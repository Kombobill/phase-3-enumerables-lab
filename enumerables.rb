...
# where the heat level of the food is greater 
...
def print_spiciest_foods(spicy_foods)
  spicy_foods.each do |spicy_food|
    if spicy_food[:heat_level] > 5
      heat_level_string = "🌶" * spicy_food[:heat_level]
      puts "#{spicy_food[:name]} (#{spicy_food[:cuisine]}) | Heat Level: #{heat_level_string}"
    end
  end
end
...
# the average heat level of all the spicy foods in the a
